        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4 col-lg-3">
                <div class="footer__social">
                    ...
                    <a href="<?php the_field('instagram', 2) ?>"
                    ...
                    <a href="<?php the_field('facebook', 2) ?>"
                       class="footer__social-item">
                        <svg width="13"
                             height="24"
                             viewBox="0 0 13 24"
                    ...
                    <a href="<?php the_field('youtube', 2) ?>"
                       class="footer__social-item">
                        <svg width="29"
                             height="29"
                             viewBox="0 0 29 29"
                ...
                <div class="footer__contacts">
                    ...
                    <div class="footer__contacts-item">
                        <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/pointer.svg"
                             alt="указатель"
                             class="footer__contacts-logo">
                        <address><?php the_field('full_addr', 2) ?></address>
                    </div>
                </div>
            </div>
        </div>
