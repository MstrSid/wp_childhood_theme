...
?>
                ...
                <ul class="glide__slides">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                                    <h2 class="slider__title">Воплощаем мечты
                                        детства</h2>
                                    <a href="#"
                    ...
                    <li style="background-image: url('<?php echo bloginfo('template_url'); ?>/assets/img/bg_2.jpg')"
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                                    <h2 style="color: #fff"
                                        class="slider__title">Подарки для детей
                                        и родителей</h2>
                                    <a href="#"
                                       class="button">Узнать больше</a>
                                </div>
                    ...
                    <li style="background-image: url('<?php echo bloginfo('template_url'); ?>/assets/img/bg_3.jpg')"
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                                    <h2 class="slider__title">Друг, который
                                        всегда с тобой</h2>
                                    <a href="#"
                                       class="button">Узнать больше</a>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1 col-lg-5 offset-lg-1">
                        <div class="about__img">
                            <img src="<?php echo bloginfo('template_url'); ?>/assets/img/about.jpg"
                                 alt="про компанию">
                        </div>
                    </div>
                    <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-6 col-xl-5 offset-xl-1">
                        ...
                        <div class="about__text">
                            Наша компания уже больше десяти лет дарит позитивные
                            эмоции детям и их родителям. Мы воплощаем все
                            детские мечты и помогаем родителям дарить счастливое
                            детство!
                            <br> <br>
                            Но и взрослые иногда так нуждаются в детских
                            эмоциях! Мы можем и это, ведь так приятно
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img"
                             src="<?php echo bloginfo('template_url'); ?>/assets/img/team.jpg"
                             alt="наша команда">
                    </div>
                </div>
            </div>
                ...
                <div class="toys__wrapper">
                    <div class="toys__item"
                        ...
                        <div class="toys__item-info">
                            ...
                            <div class="minibutton toys__trigger">Подробнее
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="toys__item"
                        ...
                        <div class="toys__item-info">
                            ...
                            <div class="toys__item-descr">
                                Хотите, чтобы ваш ребенок был под защитой даже
                                ночью? Купите ему совенка!
                            </div>
                            <div class="minibutton toys__trigger">Подробнее
                            </div>
                        </div>
                    ...
                    <div class="toys__item"
                        ...
                        <div class="toys__item-info">
                            ...
                            <div class="toys__item-descr">
                                Кролики бывают разные... Но все они необычайно
                                милые!
                            </div>
                            <div class="minibutton toys__trigger">Подробнее
                            </div>
                    ...
                    <div class="toys__item"
                        ...
                        <div class="toys__item-info">
                            ...
                            <div class="toys__item-descr">
                                Кстати, у нас большой выбор игрушек, позу
                                которых выбирает сам ребенок. (Долговечные.
                    ...
                    <div class="toys__item"
                        ...
                        <div class="toys__item-info">
                            ...
                            <div class="toys__item-descr">
                                Ваш ребенок без ума от персонажа мультика? Мы
                                следим за всеми трендами и рады предложить как
                                самых современных, так и персонажей "из нашего
                                детства"
                            </div>
                            <div class="minibutton toys__trigger">Подробнее
                            </div>
                    ...
                    <div class="toys__item"
                        ...
                        <div class="toys__item-info">
                            ...
                            <div class="toys__item-descr">
                                Хотите, чтобы вашему ребенку все завидовали?
                                Подарите игрушки нашего собственного
                                производства! Они уникальны и ваш ребенок будет
                                гордым обладателем эксклюзива!
                            </div>
                            <div class="minibutton toys__trigger">Подробнее
                            </div>
                        </div>
                ...
                <div class="toys__wrapper">
                    ...
                    <div class="toys__item"
                        ...
                        <div class="toys__item-info">
                            ...
                            <div class="toys__item-descr">
                                Кто в детстве не хотел научиться летать? А змей
                                поможет поймать ветер и унести все заботы
                                далеко-далеко...
                            </div>
                            <div class="minibutton toys__trigger">Подробнее
                            </div>
                    ...
                    <div class="toys__item"
                        ...
                        <div class="toys__item-info">
                            ...
                            <div class="toys__item-descr">
                                Попробуйте заинтересовать ребенка музыкой! Может
                                в нем таится будущий Джаред Лето!
                            </div>
                            <div class="minibutton toys__trigger">Подробнее
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span>Не нашли то, что искали?</span> Свяжитесь с
                            нами - и мы с радостью создадим любую игрушку по
                            вашему желанию. Вы можете выбрать все: размер,
                            материал, формы...!
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="aboutus__text">
                            Желания сделать как можно больше детей счастливыми.
                            Именно с этой идеи все и зарождалось.
                            <br><br>
                            Первые игрушки, сделанные вручную были классическими
                            плюшевыми медведями, которые разошлись настолько
                            быстро, что нас завалили заказами на несколько
                            месяцев вперед. Именно в то время мы поняли, что
                            идем правильным путем, вкладывая все силы и эмоции в
                            наши игрушки.
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="aboutus__text">
                            Мы делали их вручную, из лучших материалов и не
                            жалея времени. Но мы росли и наш ассортимент
                            расширился и фабричными изделиями.
                            <br><br>
                            Выбирая нас, вы можете быть уверены, что мы всегда
                            следим за качеством закупок и никогда не предоставим
                            вам опасный или некачественный товар.
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="aboutus__text">
                            И даже спустя столько лет мы продолжаем создавать
                            игрушки вручную. Как самые простые, так и те, что
                            идут в ногу со временем. Добавляя электроники и
                            оживляя лучших друзей ребятишек, мы всегда следим за
                            качеством и безопасностью. Каждая отдельная игрушка
                            проходит индивидуальный контроль по всем необходимым
                            стандартам.
                            <br><br>
                            Ведь счастливое лицо ребенка - это лучшая награда
                            для нас!
                        </div>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="contacts"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                            Мы находимся в Москве, метро "Парк победы", в
                            деловом центре "Парк победы", второй этаж
                            <br> <br>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="title contacts__minititle">Свяжитесь с
                            нами
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="title contacts__minititle">Оставьте ваш
                            отзыв
                        </div>
                        <form action="#"
                              class="contacts__feed">
                            <label for="feedname">
                                Ваше имя <span>*</span>
                            </label>
                            <input required
                            ...
                            <svg class="confirm ldt-bounce-in"
                                 version="1.1"
                                 id="Capa_1"
                                 xmlns="http://www.w3.org/2000/svg"
                                 xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <svg class="reject ldt-bounce-in "
                                 xmlns="http://www.w3.org/2000/svg"
                                 xmlns:xlink="http://www.w3.org/1999/xlink"
                                 version="1.1"
                                 id="圖層_1"
                                    ...
                                    <g style="transform-origin: 50px 50px 0px; transform: scale(1);">
                                        <g class="ld ldt-bounce-in"
                                           style="transform-origin: 50px 50px 0px; animation-duration: 1.7s; animation-delay: 0s; animation-direction: normal;">
                                            <g>
                                                <style type="text/css"
                                                       style="transform-origin: 50px 50px 0px;">.st0 {
                                                        fill: #333333;
                                                    }
                                ...
                                <ul class="glide__slides">
                                    <li class="glide__slide">
                                        ...
                                        <div class="feedslider__text">
                                            Спасибо огромное за вежливость и
                                            терпение. Обратился к вам только с
                                            идеей для подарка, а вы развили её
                                            до полноценного проекта! Так что мой
                                            сын теперь круглые сутки играет с
                                            железной дорогой, построенной по его
                                            планам)
                                            <br><br>
                                            Отдельное спасибо менеджеру
                                            Маргарите за терпение и стойкость!
                                        </div>
                                    </li>
                                    <li class="glide__slide">
                                        <div class="feedslider__title">
                                        ...
                                        <div class="feedslider__text">
                                            Заказывал у ребят целую партию
                                            игрушек для детского сада. Новый год
                                            прошел на ура! Теперь все детишки
                                            счастливы и не расстаются со своими
                                            подарками, а самые хитрые спрашивают
                                    ...
                                    <li class="glide__slide">
                                        ...
                                        <div class="feedslider__text">
                                            Решила к дню рождения своей малышки
                                            заказать подарки здесь. И ни сколько
                                            не жалею! Мишка именно такой, как я
                                            хотела, прямо как у меня в детстве:
                                            мягкий, приятный на ощупь и оочень
                                            милый. Сразу видно, что ручная
                                            работа.
                                        </div>
                                    </li>
                                </ul>
