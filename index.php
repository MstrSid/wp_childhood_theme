...
?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                        ...
                        if (!empty($image)): ?>
                            <img class="specialists__img" src="<?php echo $image['url'] ?>"
                                 alt="<?php echo $image['alt'] ?>">
                        <?php endif; ?>
                </div>
            </div>
    ...
    <div class="aboutus"
         id="aboutus">
        <div class="container">
            <h1 class="title"><?php the_field('custom_title_history'); ?></h1>
            <div class="row">
                <div class="col-lg-6">
                    <div class="subtitle">
                    ...
                    <div class="aboutus__text">
                        <?php the_field('block_one_txt'); ?>
                    </div>
                </div>
                <div class="col-lg-6">
                    <?php
                    $image = get_field('block_one_img');
                    if (!empty($image)): ?>
                        <img class="aboutus__img" src="<?php echo $image['url'] ?>"
                             alt="<?php echo $image['alt'] ?>">
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="aboutus__text">
                        <?php the_field('block_three_txt'); ?>
                    </div>
                </div>
                <div class="col-lg-6">
                    <?php
                    $image = get_field('block_three_img');
                    if (!empty($image)): ?>
                        <img class="aboutus__img" src="<?php echo $image['url'] ?>"
                             alt="<?php echo $image['alt'] ?>">
                    <?php endif; ?>
