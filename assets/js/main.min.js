!function (i) {
	...
	r = function () {
		...
		var T = P, G = ["touchstart", "mousedown"],
		...
		var B = {
			Html: function (e, t) {
					...
					set: function (t) {
						var e = function (o, n, r) {
							var s = [function (e, i) {
								...
								return {
									modify: function (t) {
										var e = s.Gaps.value, i = s.Sizes.width,
				...
				return s.on("move", function (t) {
					var e = r.Gaps.value, i = r.Sizes.length,
				...
				var t = {
					mount: function () {
						...
						var t = this.move, e = this.length, i = t.steps,
							o = t.direction,
				...
				var i = new x, m = 0, f = 0, g = 0, o = !1, v = !0,
					n = !!T && {passive: !0}, t = {
						mount: function () {
							this.bindSwipeStart()
						}, start: function (t) {
							...
							if (!d.disabled) {
								var e = d.settings, i = e.touchAngle,
									o = e.touchRatio, n = e.classes,
									r = this.touches(t), s = y(r.pageX) - f,
									a = y(r.pageY) - g, l = Math.abs(s << 2),
									u = Math.abs(a << 2), c = Math.sqrt(l + u),
									h = Math.sqrt(u);
							...
							if (!d.disabled) {
								var e = d.settings, i = this.touches(t),
									o = this.threshold(t), n = i.pageX - f,
									r = 180 * m / Math.PI,
				...
				var i = new x, n = {
					mount: function () {
						...
						for (var e = 0; e < t.length; e++) i.on(["click",
							"touchstart"], t[e], this.click)
					}, unbind: function (t) {
						for (var e = 0; e < t.length; e++) i.off(["click",
							"touchstart"], t[e])
					}, click: function (t) {
				...
				return d(n, "time", {
					...
					n.unbind()
				}), t.on(["run.before", "pause", "destroy", "swipe.start",
					"update"], function () {
					n.stop()
				...
				var o = new x, n = t.settings, r = S(n.breakpoints),
					s = l({}, n), a = {
						match: function (t) {
		...
		function i(t, e, i, o, n) {
			try {
				var r = document.querySelectorAll(t),
					...
					a = document.querySelector(i), l = function () {
	...
	e.default = function () {
		o.then(function () {
			try {
				var t = o.map("map", {
					center: [55.738164984877976, 37.50722765922547], zoom: 16
				});
	...
	zm = function () {
		...
		return function n(r, s, a) {
				...
				(function (process) {
					...
					"function" != typeof Array.prototype.reduce && (Array.prototype.reduce = function (t, e) {
						...
						var n = Object.prototype.hasOwnProperty,
							...
							s = ["toString", "toLocaleString", "valueOf",
					...
					}), Nn("promise/polyfill", ["./promise", "./utils",
					...
					}), Nn("promise/promise", ["./config", "./utils", "./all",
						"./race", "./resolve", "./reject", "./asap",
						"exports"], function (t, e, i, o, n, r, s, a) {
						"use strict";
						...
						var g = t.config, v = (t.configure, e.objectOrFunction),
							y = e.isFunction, b = (e.now, i.all), C = o.race,
							w = n.resolve, x = r.reject, k = s.asap;
						g.async = k;
					...
					var handlers = window.__dgApi__.callbacks || [],
						chain = Promise.resolve(), MC, NC, OC, PC, QC, RC;
					...
					handlers.forEach(function (t) {
						...
						function handleJsonp(t, e, i, o) {
							var n = uniqid++, r = t.jsonpCallback || "callback",
								...
								a = new RegExp("((^|\\?|&)" + r + ")=([^&]+)"),
								l = o.match(a), u = doc.createElement("script"),
								c = 0,
						...
						var win = window, doc = document,
							rurl = /^([\w.+-]+:)?(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,
							twoHundo = /^20\d$/, ajaxLocParts, ajaxLocation,
						...
						initialize: function (t) {
							...
							var e, i, o, n, r, s, a,
								...
								u = this._vertices, c = this._drawings,
								h = DG.Point, d = t.width, p = [[], [], []],
								_ = [];
							...
							o = t.vertices[e + 1].x, n = 4 * d / 3, u[0].push(new h(o, +d)), u[1].push(new h(o, -d)), u[0].push(new h(o - n, +d)), u[1].push(new h(o - n, -d)), c[0].push("L"), c[1].push("L"), _.push(Math.abs(o) - r), u[1].reverse(), c[1].reverse(), a = DG.VertexTransform.getAnglesSum(s.fullAngle, t.getAngle()), l(u, a, u.pop()[0]), o = u[0].length, n = u[1].length, this._arcs = p[2].map(function (t) {
								...
								vertices: [u[0][o - 2], u[0][o - 1], u[1][0],
									u[1][1]],
								drawings: ["M", "C"]
							}, this[1] = {
						...
						initialize: function (t, e) {
							...
							var i = e.vertices[0], o = Math.abs(i.y),
								n = t.vertices[1].x, r = i.x, s = n - r + o + o;
						...
						initialize: function (t, e) {
							...
							return 0 === t ? l[0] : 1 === t ? l[this.order] : (i = (e = 1 - t) * e, o = t * t, a = 2 < this.order ? (n = i * e, r = i * t * 3, s = e * o * 3, t * o) : (l = [l[0],
								l[1], l[2], {
									x: 0,
									y: 0
							...
							return o = 2 < this.order ? (e = r * r, i = r * t * 2, t * t) : (n = [n[0],
								n[1], {
									x: 0,
									y: 0
						...
						return ("number" == typeof t || t instanceof DG.Point) && (t = Array.prototype.slice.call(arguments)), "number" == typeof t[0] ? (t = t.length < 7 ? [new DG.Point(t[0], t[1]),
							new DG.Point(t[2], t[3]),
							new DG.Point(t[4], t[5])] : [new DG.Point(t[0], t[1]),
							new DG.Point(t[2], t[3]), new DG.Point(t[4], t[5]),
							new DG.Point(t[6], t[7])], new DG.Bezier(t)) : new DG.Bezier(t, !0)
					}, DG.Bezier.WEIGHT = [.362683783378362, .362683783378362,
						.3137066458778873, .3137066458778873, .2223810344533745,
						.2223810344533745, .1012285362903763,
						.1012285362903763], DG.Bezier.ABSCISSA = [-.1834346424956498,
						.1834346424956498, -.525532409916329, .525532409916329,
						-.7966664774136267, .7966664774136267,
						-.9602898564975363,
						.9602898564975363], DG.TimeBezier = DG.Bezier.extend({
						initialize: function (t, e, i) {
							DG.Bezier.prototype.initialize.call(this, [DG.TimeBezier.START,
								t, e, DG.TimeBezier.END], i)
						}, getYbyX: function (t) {
						...
						initialize: function (t, e) {
							...
							var e, i, o, n = this.getLUT(), r = n.length - 1,
								s = 0;
							if (t <= 0) return 0;
							if (t >= n[r].l) return 1;
							for (; t < n[e = s + (r - s >> 1)].l ? r = e : s = e, !(r - s < 2);) ;
							t = (t - n[s].l) / (n[r].l - n[s].l), i = n[s].x + (n[r].x - n[s].x) * t, o = n[s].y + (n[r].y - n[s].y) * t;
							var a, l, u, c, h = r / n.length, d = s / n.length,
								p = 1 / n.length / 10, _ = Math.pow(2, 53) - 1;
						...
						vertices: {
							16: [[-6.5, -1.8], [-6.0522, -1.8],
								[-7.0975, -5.2537], [-6.6619, -6.2565],
								[-6.598, -6.355], [-6.1757, -6.147],
								[.8371, -.3552], [.9275, -.1764],
								[.9275, .1764], [.8371, .3552],
								[-6.1757, 6.147], [-6.598, 6.355],
								[-6.6619, 6.2565], [-7.0975, 5.2537],
								[-6.0522, 1.8], [-6.5, 1.8]],
							17: [[-9, -2.4], [-7.889, -2.4], [-9.9245, -7.2548],
								[-9.3363, -8.6404], [-9.3448, -8.6448],
								[-8.8717, -8.3508], [1.0285, -.3552],
								[1.119, -.1764], [1.119, .1764],
								[1.0285, .3552], [-8.8717, 8.3508],
								[-9.3448, 8.6448], [-9.3363, 8.6404],
								[-9.9245, 7.2548], [-7.889, 2.4], [-9, 2.4]],
							18: [[-11.5, -3], [-10.0795, -3],
								[-12.4909, -9.3173], [-11.8402, -10.7654],
								[-11.5986, -10.7073], [-10.938, -10.2258],
								[1.1497, -.3552], [1.2402, -.1764],
								[1.2402, .1764], [1.1497, .3552],
								[-10.938, 10.2258], [-11.5986, 10.7073],
								[-11.8402, 10.7654], [-12.4909, 9.3173],
								[-10.0795, 3], [-11.5, 3]],
							19: [[-13, -3.6], [-11.66, -3.6],
								[-14.1696, -10.8351], [-13.5189, -12.2832],
								[-13.2773, -12.2251], [-12.6167, -11.7436],
								[1.3061, -.3552], [1.3966, -.1764],
								[1.3966, .1764], [1.3061, .3552],
								[-12.6167, 11.7436], [-13.2773, 12.2251],
								[-13.5189, 12.2832], [-14.1696, 10.8351],
								[-11.66, 3.6], [-13, 3.6]]
						},
						drawings: {
							16: ["M", "L", "L", "C", "L", "C", "L", "C", "L",
								"L"],
							17: ["M", "L", "L", "C", "L", "C", "L", "C", "L",
								"L"],
							18: ["M", "L", "L", "C", "L", "C", "L", "C", "L",
								"L"],
							19: ["M", "L", "L", "C", "L", "C", "L", "C", "L",
								"L"]
						}
					}, function (t) {
							...
							if (this._map) {
								...
								if (e.autoPan) {
									...
									var a = i.layerPointToContainerPoint(r),
										...
										h = i.getSize(), d = 0, p = 0;
									0 !== h.x && 0 !== h.y && (a.x + n + c.x > h.x && (d = a.x + n - h.x + c.x), a.x - d - u.x < 0 && (d = a.x - u.x), a.y + o + c.y > h.y && (p = a.y + o - h.y + c.y), a.y - p - u.y < 0 && (p = a.y - u.y), (d || p) && i.fire("autopanstart").panBy([d,
										p]))
								}
							}
						},
						...
						_updateLayout: function () {
							var t, e = this.options, i = this._contentNode,
								o = this._wrapper, n = i.style, r = o.style,
					...
					DG.setOptions = L.setOptions = DG.Util.setOptions = function (t, e) {
						...
						nonBubblingEvents: ["click", "dblclick", "mouseover",
					...
					DG.Map.include({
						...
						_restrictZoom: function (t, e) {
							if (this._layers && this.projectDetector.enabled() && 0 === this._tileLayersNumber) {
								var i = this.options, o = !!i.maxZoom,
									n = this.baseLayer,
					...
					DG.Map.Drag.include({
						...
						for (var o = !1, n = 0, r = e.length - 1; n < e.length; r = n++) {
							var s = i(e[n]), a = i(e[r]), l = s[0], u = s[1],
								c = a[0], h = a[1];
							...
							if (e) {
								...
								if (void 0 === t && (t = e.getCenter()), void 0 !== this._tileZoom) {
									var o = this._getTiledPixelBounds(t),
										...
										l = new L.Bounds(n.getBottomLeft().subtract([a,
											-a]), n.getTopRight().add([a, -a]));
					...
					_dereq_("dustjs-helpers"), DG.dust = function (t, e) {
						...
						_apiMap: [["requestFullscreen", "exitFullscreen",
						...
						options: {subdomains: "0123", dataFilter: null},
						_url: !1,
						initialize: function (t, e) {
						...
						getTileData: function (e, t) {
							var i = this.getTileKey(e), o = this,
						...
						_polygonLngLatToPoints: function (e, i, t) {
							...
							return t.map(function (t) {
								return t.map(function (t) {
									return o.project([t[1],
										t[0]], i).round().subtract(e)
								})
							})
						},
						...
						initialize: function (t, e) {
							...
							var t = !1, e = "Webkit Moz O ms Khtml".split(" "),
						...
						"adm_div.city": "Сittà",
						go_to: "Come arrivare",
						show_organization_in_building: ["{n} azienda in tutto",
							"{n} aziende in tutto"],
						...
						"adm_div.city": "Город",
						go_to: "Проехать сюда",
						show_organization_in_building: ["Всего {n} организация",
							"Всего {n} организации", "Всего {n} организаций"],
						...
						show_organization_in_building: ["{n} organization total",
						...
						"adm_div.city": "Město",
						go_to: "Cesta sem",
						show_organization_in_building: ["Celkem {n} organizace",
							"Celkem {n} organizace", "Celkem {n} organizací"],
						back_button: "Zpět",
						...
						"adm_div.city": "Ciudad",
						go_to: "Ir para allá",
						show_organization_in_building: ["Total {n} organización",
							"Total {n} organizaciones",
							"Total {n} organizaciones"],
					...
					FirmCard.prototype = {
						...
						payMethods: ["americanexpress", "cash", "dinersclub",
							"goldcrown", "internet", "mastercard", "noncash",
							"visa"],
						_msgs: {},
						...
						setLang: function (t) {
							...
							if (v) {
								for (var P, E, T, e = (t = t || {}).zoneOffset || 0, G = {}, A = t.now || FirmCard.DataHelper.getProjectTime(e).getTime(), M = [], l = [], c = [], i = ["Mon",
									"Tue", "Wed", "Thu", "Fri", "Sat",
									"Sun"], o = ["monday", "tuesday",
									"wednesday", "thursday", "friday",
									"saturday",
									"sunday"], O = t.localLang || this.localLang, h = t.localWorkingDays || [0,
									1, 1, 1, 1, 1,
									0], d = t.firstdayOffset || 1, r = t.minHoursToDisplayClosure || 4, S = function (t, e) {
						...
						t: function (t, e, i) {
							...
							linkPhoto: ["fotografie", "fotografie",
								"fotografií"],
							linkBooklet: "Leták",
							tommorow: "zítra",
							...
							linkReviews: ["comentario", "comentarios",
								"comentarios"],
						...
						options: {
							...
							disableLabel: !1,
							updateWhenIdle: !1
						}, statics: {Dictionary: {}}, initialize: function (t) {
							...
							return t.map(function (t) {
								return t.map(function (t) {
									return i.project([t[1],
										t[0]]).round().subtract(e)
								})
							})
						...
						_calcAngle: function (t, e, i) {
							...
							var o = e.x - t.x, n = i.x - t.x, r = e.y - t.y,
								s = i.y - t.y, a = o * n + r * s,
								l = Math.sqrt(o * o + r * r),
								u = Math.sqrt(n * n + s * s);
						...
						_calcGreatCircle: function (t, e) {
							if (e = this._normalizeLatLng(e, t), t.equals(e, 1)) return [t,
								e];
							if (180 == Math.abs(e.lng - t.lng)) {
								var i = 0 < t.lat + e.lat ? 90 : -90;
								return [t, DG.latLng(i, t.lng),
									DG.latLng(i, e.lng), e]
							}
							var o = [];
						...
						_getFormatedDistance: function () {
							var t = this._calcDistance.apply(this, arguments),
								e = "m";
							return [(t = 1e3 < t ? (e = "km", 1e3 < (t /= 1e3) ? (t = t.toFixed()).slice(0, -3) + " " + t.slice(-3) : t.toFixed(2).split(".").join(this.t("delimiter"))) : Math.round(t)) || 0,
								" ", this.t(e)].join("")
						},
						...
						options: {
							...
							textDirection: "auto",
							iconHTML: ['<img class="dg-ruler__label-spacer" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="26" height="26" />',
						...
						statics: {domClass: "dg-ruler__label"},
						addTo: function (t, e) {
					...
					function k1(t, e) {
						return t.w('<address class="dg-map-geoclicker__address">').s(e.getPath(!1, ["address",
							"header"]), e, {block: l1}, {}).s(e.getPath(!1, ["address",
							"drilldown"]), e, {block: m1}, {}).w("</address>")
					}
					...
					function b0(t, e) {
						return t.w('<address class="dg-map-geoclicker__address">').s(e.getPath(!1, ["address",
							"header"]), e, {block: c0}, {}).s(e.getPath(!1, ["address",
							"drilldown"]), e, {block: d0}, {}).w("</address>")
					}
					...
					function O_(t, e) {
						return t.w('<a id="').f(e.getPath(!1, ["firm",
							"id"]), e, "h").w('" class="dg-popup__link" href="#">').f(e.getPath(!1, ["firm",
							"name"]), e, "h").w("</a>")
					}

					function QZ(t, e) {
						return t.w('<div class="dg-firm-card__schedule dg-schedule dg-schedule_open_').x(e.getPath(!1, ["forecast",
							"open"]), e, {
							else: RZ,
							block: SZ
						}, {}).w(" dg-schedule_works-everyday_").x(e.getPath(!1, ["schedule",
							"everyday"]), e, {
							else: TZ,
							block: UZ
					...
					function VZ(t, e) {
						return t.x(e.getPath(!1, ["forecast",
							"today"]), e, {block: WZ}, {}).s(e.getPath(!1, ["forecast",
							"now"]), e, {block: $Z}, {}).nx(e.getPath(!1, ["schedule",
							"everyday"]), e, {block: a$}, {})
					}

					function WZ(t, e) {
						return t.w('<div class="dg-schedule__today"><div class="dg-schedule__today-inner">').f(e.getPath(!1, ["forecast",
							"today",
							"text"]), e, "h").w("&nbsp;").x(e.getPath(!1, ["forecast",
							"today",
							"from"]), e, {block: XZ}, {}).x(e.getPath(!1, ["schedule",
							"lunch"]), e, {block: YZ}, {}).w("</div></div>")
					}

					function XZ(t, e) {
						return t.f(e.getPath(!1, ["forecast", "today",
							"from"]), e, "h").w("&ndash;").f(e.getPath(!1, ["forecast",
							"today", "to"]), e, "h")
					}

					function YZ(t, e) {
						return t.w(",&nbsp;").f(e.getPath(!1, ["forecast",
							"today",
							"lunchStr"]), e, "h").w("&nbsp;").s(e.getPath(!1, ["schedule",
							"lunch"]), e, {block: ZZ}, {})
					}
					...
					function $Z(t, e) {
						return t.w('<div class="dg-schedule__now"><span class="dg-schedule__now-text">').f(e.getPath(!0, []), e, "h").s(e.getPath(!1, ["schedule",
							"comment"]), e, {block: _Z}, {}).w("</span></div>")
					}
					...
					function a$(t, e) {
						return t.x(e.getPath(!1, ["schedule",
							"week"]), e, {block: b$}, {})
					}

					function b$(t, e) {
						return t.x(e.getPath(!1, ["schedule", "week",
							"evently"]), e, {block: c$}, {}).x(e.getPath(!1, ["schedule",
							"week", "table"]), e, {block: k$}, {})
					}

					function c$(t, e) {
						return t.w('<div class="dg-schedule__table">').s(e.getPath(!1, ["schedule",
							"week", "evently"]), e, {block: d$}, {}).w("</div>")
					}
					...
					function k$(t, e) {
						return t.w('<div><div class="dg-schedule__table"><div class="dg-schedule__tc dg-schedule__tc_pre"><div class="dg-schedule__day-name">&nbsp;</div><div class="dg-schedule__table-clock dg-schedule__td"></div>').x(e.getPath(!1, ["schedule",
							"week",
							"hasLunch"]), e, {block: l$}, {}).w("</div>").s(e.getPath(!1, ["schedule",
							"week",
							"table"]), e, {block: m$}, {}).w("</div>  </div>")
					}
					...
					function aZ(t, e) {
						return t.h("eq", e, {else: bZ, block: eZ}, {
							key: fZ,
							value: "flamp_stars",
							type: "string"
						}, "h")
				...
				o = this, n = function (a) {
					...
					function t(n, r) {
						return function (t, e, i, o) {
							return function (t, e, i, o, n, r) {
								var s, a, l, u, c = i.block, h = i.else,
									d = _(e) || {};
					...
					var o = {}, e = {
						tap: function (t, e, i) {
							...
							var n, r = o.key, s = o.method, a = o.operand,
								l = o.round;
			...
			5: [function (_dereq_, module, exports) {
				(function (process) {
					...
					m4 = this, n4 = function () {
						...
						var dust = {version: "2.7.5"}, NONE = "NONE",
						...
						for (var f in dust.config = {
							...
							return "function" == typeof t ? (t = t.apply(e.current(), [this,
								e, null, {
									auto: i,
									filters: o
			...
			7: [function (t, e, i) {
				...
				var c, h, d, p, _, m, f, g, v, y, C, w, x, k, D, L, z, P, E, T,
					G = b.Evented.prototype;
				G.addEventListener = G.on, G.removeEventListener = G.clearAllEventListeners = G.off, G.addOneTimeEventListener = G.once, G.fireEvent = G.fire, G.hasEventListeners = G.listens, b.Mixin = {Events: G}, p = navigator.userAgent.toLowerCase(), _ = document.documentElement, m = "ActiveXObject" in window, f = -1 !== p.indexOf("webkit"), g = -1 !== p.indexOf("phantom"), v = -1 !== p.search("android [23]"), y = -1 !== p.indexOf("chrome"), C = -1 !== p.indexOf("gecko") && !f && !window.opera && !m, w = 0 === navigator.platform.indexOf("Win"), x = "undefined" != typeof orientation || -1 !== p.indexOf("mobile"), k = !window.PointerEvent && window.MSPointerEvent, D = window.PointerEvent || k, L = m && "transition" in _.style, z = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix && !v, P = "MozPerspective" in _.style, E = "OTransition" in _.style, T = !window.L_NO_TOUCH && (D || "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch), b.Browser = {
					...
					if (t) for (var i = e ? [t,
						e] : t, o = 0, n = i.length; o < n; o++) this.extend(i[o])
				}, b.Bounds.prototype = {
					extend: function (t) {
						...
						t = b.bounds(t);
						var e = this.min, i = this.max, o = t.min, n = t.max,
							r = n.x >= e.x && o.x <= i.x,
							s = n.y >= e.y && o.y <= i.y;
						return r && s
					}, overlaps: function (t) {
					...
					b.DomUtil.TRANSFORM = b.DomUtil.testProp(["transform",
						"WebkitTransform", "OTransform", "MozTransform",
						"msTransform"]);
					var t = b.DomUtil.TRANSITION = b.DomUtil.testProp(["webkitTransition",
					...
					if (b.DomUtil.TRANSITION_END = "webkitTransition" === t || "OTransition" === t ? t + "End" : "transitionend", "onselectstart" in document) b.DomUtil.disableTextSelection = function () {
						...
						var e = b.DomUtil.testProp(["userSelect",
							"WebkitUserSelect", "OUserSelect", "MozUserSelect",
							"msUserSelect"]);
					...
					equals: function (t, e) {
						...
						return b.latLngBounds([this.lat - e,
							this.lng - i], [this.lat + e, this.lng + i])
					}, clone: function () {
					...
					extend: function (t) {
						...
						t = b.latLngBounds(t);
						var e = this._southWest, i = this._northEast,
							o = t.getSouthWest(), n = t.getNorthEast(),
					...
					options: {
						...
						var i = b.point(e.paddingTopLeft || e.padding || [0,
								0]),
							o = b.point(e.paddingBottomRight || e.padding || [0,
								0]), n = this.getBoundsZoom(t, !1, i.add(o));
						...
						var i = this.getSize(), o = e.divideBy(2).round(),
							n = i.divideBy(2).round(), r = o.subtract(n);
						...
						var o = this.getZoom() || 0, n = this.getMinZoom(),
							r = this.getMaxZoom(), s = t.getNorthWest(),
							a = t.getSouthEast(),
						...
						return s.round().equals([0,
							0]) ? t : this.unproject(o.add(s), e)
					...
					bounds: b.bounds([-20037508.34279,
						-15496570.73972], [20037508.34279, 18764656.23138]),
					project: function (t) {
						var e = Math.PI / 180, i = this.R, o = t.lat * e,
							n = this.R_MINOR / i, r = Math.sqrt(1 - n * n),
							s = r * Math.sin(o),
					...
					options: {
						...
						var n = Math.floor(t / 2), r = Math.floor(e / 2),
							s = i - 1, a = new b.Point(+n, +r);
						a.z = +s;
						...
						n && (this._globalTileRange = this._pxBoundsToTileRange(n)), this._wrapX = e.wrapLng && !this.options.noWrap && [Math.floor(t.project([0,
							e.wrapLng[0]], o).x / i.x), Math.ceil(t.project([0,
							e.wrapLng[1]], o).x / i.y)], this._wrapY = e.wrapLat && !this.options.noWrap && [Math.floor(t.project([e.wrapLat[0],
							0], o).y / i.x),
						...
						if (e) {
							...
							if (void 0 === t && (t = e.getCenter()), void 0 !== this._tileZoom) {
								var o = this._getTiledPixelBounds(t),
									...
									r = n.getCenter(), s = [],
									a = this.options.keepBuffer,
									l = new b.Bounds(n.getBottomLeft().subtract([a,
										-a]), n.getTopRight().add([a, -a]));
								for (var u in this._tiles) {
									var c = this._tiles[u].coords;
						...
						var e = this._map, i = this.getTileSize(),
							o = t.scaleBy(i), n = o.add(i),
						...
						var e = this.getTileSize();
						return new b.Bounds(t.min.unscaleBy(e).floor(), t.max.unscaleBy(e).ceil().subtract([1,
							1]))
					...
					getTileUrl: function (t) {
						var e = this._tileCoordsToBounds(t),
							...
							n = (1.3 <= this._wmsVersion && this._crs === b.CRS.EPSG4326 ? [o.y,
								i.x, i.y, o.x] : [i.x, o.y, o.x,
								i.y]).join(","),
					...
					options: {
						...
						var o = t.offsetHeight, n = this.options.maxHeight,
						...
						if (!(!this.options.autoPan || this._map._panAnim && this._map._panAnim._inProgress)) {
							...
							var r = t.layerPointToContainerPoint(n),
								...
								u = t.getSize(), c = 0, h = 0;
							r.x + o + l.x > u.x && (c = r.x + o - u.x + l.x), r.x - c - a.x < 0 && (c = r.x - a.x), r.y + i + l.y > u.y && (h = r.y + i - u.y + l.y), r.y - h - a.y < 0 && (h = r.y - a.y), (c || h) && t.fire("autopanstart").panBy([c,
								h])
						}
					}, _onCloseButtonClick: function (t) {
						this._close(), b.DomEvent.stop(t)
					}, _getAnchor: function () {
						return b.point(this._source && this._source._getPopupAnchor ? this._source._getPopupAnchor() : [0,
							0])
					}
					...
					options: {
						...
						var e = this._map, i = this._container,
							o = e.latLngToContainerPoint(e.getCenter()),
							n = e.layerPointToContainerPoint(t),
							r = this.options.direction, s = i.offsetWidth,
							a = i.offsetHeight,
							l = b.point(this.options.offset),
							u = this._getAnchor();
						t = "top" === r ? t.add(b.point(-s / 2 + l.x, -a + l.y + u.y)) : "bottom" === r ? t.subtract(b.point(s / 2 - l.x, -l.y)) : "center" === r ? t.subtract(b.point(s / 2 + l.x, a / 2 - u.y + l.y)) : "right" === r || "auto" === r && n.x < o.x ? (r = "right", t.add([l.x + u.x,
							u.y - a / 2 + l.y])) : (r = "left", t.subtract(b.point(s + u.x - l.x, a / 2 - u.y - l.y))), b.DomUtil.removeClass(i, "leaflet-tooltip-right"), b.DomUtil.removeClass(i, "leaflet-tooltip-left"), b.DomUtil.removeClass(i, "leaflet-tooltip-top"), b.DomUtil.removeClass(i, "leaflet-tooltip-bottom"), b.DomUtil.addClass(i, "leaflet-tooltip-" + r), b.DomUtil.setPosition(i, t)
					}, _updatePosition: function () {
						var t = this._map.latLngToLayerPoint(this._latlng);
						this._setPosition(t)
					}, setOpacity: function (t) {
						...
						return b.point(this._source && this._source._getTooltipAnchor && !this.options.sticky ? this._source._getTooltipAnchor() : [0,
							0])
					}
					...
					simplify: function (t, e) {
						...
						var r, s, a = e.x - t.x, l = e.y - t.y, u = o.min,
							c = o.max;
						...
						var n, r = e.x, s = e.y, a = i.x - r, l = i.y - s,
							u = a * a + l * l;
					...
					getCenter: function () {
						...
						for (o = t = 0; t < l - 1; t++) if (n = a[t], r = a[t + 1], e < (o += i = n.distanceTo(r))) return s = (o - e) / i, this._map.layerPointToLatLng([r.x - s * (r.x - n.x),
							r.y - s * (r.y - n.y)])
					},
					getBounds: function () {
						return this._bounds
					...
					options: {fill: !0}, isEmpty: function () {
						...
						return l = 0 === r ? u[0] : [s / r,
							a / r], this._map.layerPointToLatLng(l)
					}, _convertLatLngs: function (t) {
					...
					initialize: function (t, e) {
						...
						return [(t = b.latLngBounds(t)).getSouthWest(),
							t.getNorthWest(), t.getNorthEast(),
							t.getSouthEast()]
					}
					...
					options: {
						...
						var t = this._radius, e = this._radiusY || t,
							i = this._clickTolerance(), o = [t + i, e + i];
					...
					_project: function () {
						var t = this._latlng.lng, e = this._latlng.lat,
							i = this._map, o = i.options.crs;
						if (o.distance === b.CRS.Earth.distance) {
							...
							!isNaN(c) && 0 !== c || (c = r / Math.cos(Math.PI / 180 * e)), this._point = l.subtract(i.getPixelOrigin()), this._radius = isNaN(c) ? 0 : Math.max(Math.round(l.x - i.project([u,
								t - c]).x), 1), this._radiusY = Math.max(Math.round(l.y - s.y), 1)
						} else {
							var h = o.unproject(o.project(this._latlng).subtract([this._mRadius,
								0]));
					...
					getEvents: function () {
						...
						if (!this._map._animatingZoom || !this._bounds) {
							...
							var t = this._bounds, e = t.getSize(),
								i = this._container;
							this._svgSize && this._svgSize.equals(e) || (this._svgSize = e, i.setAttribute("width", e.x), i.setAttribute("height", e.y)), b.DomUtil.setPosition(i, t.min), i.setAttribute("viewBox", [t.min.x,
								t.min.y, e.x,
					...
					_initContainer: function () {
						...
						var e = t._stroke, i = t._fill, o = t.options,
							n = t._container;
						...
						var e = t._point.round(), i = Math.round(t._radius),
					...
					_update: function () {
						if (!this._map._animatingZoom || !this._bounds) {
							...
							var t = this._bounds, e = this._container,
								i = t.getSize(), o = b.Browser.retina ? 2 : 1;
					...
					_requestRedraw: function (t) {
						if (this._map) {
							...
							this._redrawBounds = this._redrawBounds || new b.Bounds, this._redrawBounds.extend(t._pxBounds.min.subtract([e,
								e])), this._redrawBounds.extend(t._pxBounds.max.add([e,
								e])), this._redrawRequest = this._redrawRequest || b.Util.requestAnimFrame(this._redraw, this)
						}
					},
					_redraw: function () {
					...
					_updatePoly: function (t, e) {
						var i, o, n, r, s = t._parts, a = s.length,
							l = this._ctx;
						if (a) {
					...
					_updateCircle: function (t) {
						if (!t._empty()) {
							var e = t._point, i = this._ctx, o = t._radius,
								n = (t._radiusY || o) / o;
					...
					geometryToLayer: function (t, e) {
						...
						return void 0 !== t.alt ? [t.lng, t.lat,
							t.alt] : [t.lng, t.lat]
				...
				b.DomEvent = {
					...
					statics: {
						START: b.Browser.touch ? ["touchstart",
							"mousedown"] : ["mousedown"],
						END: {
							mousedown: "mouseup",
							touchstart: "touchend",
					...
					addHooks: function () {
						...
						if (e.fire("dragend", t), o) e.fire("moveend"); else {
							var n = this._lastPos.subtract(this._positions[0]),
								r = (this._lastTime - this._times[0]) / 1e3,
								s = i.easeLinearity, a = n.multiplyBy(s / r),
								l = a.distanceTo([0, 0]),
								u = Math.min(i.inertiaMaxSpeed, l),
								c = a.multiplyBy(u / l),
				...
				O && b.Map.addInitHook(function () {
					...
					flyTo: function (o, n, t) {
						...
						var a = this.project(this.getCenter()),
							l = this.project(o), u = this.getSize(),
							c = this._zoom;
						o = b.latLng(o), n = void 0 === n ? c : n;
						var h = Math.max(u.x, u.y),
							d = h * this.getZoomScale(c, n),
							p = l.distanceTo(a) || 1, _ = 1.42, m = _ * _,
							f = e(0), g = Date.now(), v = (e(1) - f) / _,
					...
					addDoubleTapListener: function (t, o, e) {
						...
						var r, s, a = !1, l = "_leaflet_", u = this._touchstart,
							c = this._touchend;
					...
					removeDoubleTapListener: function (t, e) {
						var i = "_leaflet_", o = t[i + this._touchstart + e],
					...
					keyCodes: {
						...
						for (e = 0, i = n.left.length; e < i; e++) o[n.left[e]] = [-1 * t,
							0];
						for (e = 0, i = n.right.length; e < i; e++) o[n.right[e]] = [t,
							0];
						for (e = 0, i = n.down.length; e < i; e++) o[n.down[e]] = [0,
							t];
						for (e = 0, i = n.up.length; e < i; e++) o[n.up[e]] = [0,
							-1 * t]
					...
					initialize: function (t) {
						...
						var e = this._marker, i = e._shadow,
					...
					addTo: function (t) {
						...
						var e = this._container = this.onAdd(t),
							i = this.getPosition(), o = t._controlCorners[i];
					...
					options: {
						...
						var e = "leaflet-control-scale",
							i = b.DomUtil.create("div", e), o = this.options;
						...
						var t = this._map, e = t.getSize().y / 2,
							i = t.distance(t.containerPointToLatLng([0,
								e]), t.containerPointToLatLng([this.options.maxWidth,
								e]));
					...
					_handleGeolocationResponse: function (t) {
						var e = t.coords.latitude, i = t.coords.longitude,
							o = new b.LatLng(e, i),
					...
					if (n) {
						...
						var c = function (t) {
							...
							var a, l, u = {
									...
									radius: 0,
									minView: 0
								}, c = [], h = [], d = [], o = this.scroller,
								p = this.event, _ = this.$, m = this;
						...
						var h = function (e) {
							...
							r = e.screen || .9, e.forward && (t = this.$(e.forward, this.clipper), this.event(t, "click", function () {
								...
								var e = t["offset" + s.origin.x],
									i = s.bar[s.origin.offsetPos], o = 0;
						...
						var d = function (a) {
							...
							var i, h, d, o, p = this.$(a.block),
								...
								m = a.limit || 80, f = a.onExpand,
								g = a.elements || [], v = a.inProgress || "",
								y = this, b = 0, C = 0, w = 0,
								x = a.waiting || 500;
	...
	e.default = function () {
		!function (t, e, i, o) {
			try {
				var n = {element: document.querySelector(t), active: !1},
